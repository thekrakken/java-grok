 ...
 * This class is the general class of exceptions produced by failed or interrupted Grok operations.
 *
 * @author anthonyc
 *
 */
public class GrokException extends Exception {
	 ...
	 */
	public GrokException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
